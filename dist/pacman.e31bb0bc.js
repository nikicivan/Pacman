...
var Pacman = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Pacman, [{
    ...
    value: function getNextMove(objectExist) {
      var nextMovePos = this.pos + this.dir.movement; //console.log(nextMovePos, "pos", this.pos, "dir", this.dir.movement);
    ...
    value: function handleKeyInput(e, objectExists) {
      ...
      if (e.keyCode >= 37 && e.keyCode <= 40) {
        dir = _setup.DIRECTIONS[e.key]; //   console.log(dir);
      } else {
        return;
      }

      var nextMovePos = this.pos + dir.movement; // console.log(nextMovePos, "pos", this.pos, "dir", dir.movement);
...
},{"./setup":"setup.js"}],"sounds/munch.wav":[function(require,module,exports) {
